...
const clientData = {
  ...
  // --------------------------------------------------------------
  theme: {
    bgColor: "#FFFFFF",      // Charizard White background
    accentColor: "#F9CF30",  // Charizard Belly Yellow accent
    fontColor: "#111111"     // Ash Black for high-contrast Neo-Brutalism
  },
  ...
  // --------------------------------------------------------------
  marquee: "BLAZE YOUR OWN TRAIL • THE FIRE WITHIN",
